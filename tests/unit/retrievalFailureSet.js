export const RETRIEVAL_FAILURE_SET = [
  ...
  // ── Regression: Production failures logged 2026-04-04/05 ─────────────────────
  {
    ...
    scenario: "indigenous sentencing principles",
    expectedPrimary: "general_criminal",
    expectedResult: "nonzero_required",
    shouldInclude: ["Gladue", "sentencing"],
    shouldExclude: [],
    expectedKeywords: ["sentencing", "indigenous", "gladue"],
    minResults: 1,
    maxResults: 3,
    landmarkMatches: [
      {
  ...
  },
  {
    ...
    shouldInclude: ["theft", "property"],
    shouldExclude: ["Jordan", "11(b)", "trial delay"],
    expectedKeywords: ["break and enter", "s. 348", "stolen"],
    minResults: 1,
    maxResults: 3,
    landmarkMatches: [
      {
  ...
  },
  {
    ...
    shouldExclude: ["sexual assault", "trafficking", "Jordan"],
    expectedKeywords: ["assault", "bodily harm"],
    minResults: 1,
    maxResults: 3,
    landmarkMatches: [
      {
