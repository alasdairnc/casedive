...
export const CRIMINAL_CODE_SECTIONS = new Map([
  ...
  [
    "236",
    {
      ...
      definition:
        "Every person who commits manslaughter is guilty of an indictable offence and liable to imprisonment for life and to a minimum punishment of imprisonment for a term of four years when a firearm is used in the commission of the offence.",
