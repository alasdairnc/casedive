...
export default function BookmarksPanel({ bookmarks, removeBookmark, clearBookmarks, onClose }) {
  const t = useTheme();
              ...
              >
                <div style={{ flexGrow: 1, minWidth: 0 }}>
                  ...
                  <div style={{
                    ...
                    color: t.text, fontWeight: "bold", lineHeight: 1.4,
                  }}>
                    {entry.citation}
                  </div>
                  ...
                  {entry.summary && (
                    <div style={{
                      ...
                      color: t.textSecondary, lineHeight: 1.5, marginTop: 6,
                  ...
                  {entry.type === "case_law" && (
                    <a
                      ...
                      style={{
                        ...
                        fontFamily: "'Helvetica Neue', sans-serif", fontSize: 11,
                        color: t.textTertiary, textDecoration: "none", marginTop: 6,
                        letterSpacing: 0.5,
                      }}
                    >
                      Search CanLII ↗
